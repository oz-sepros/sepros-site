...
const Careers = () => {
    ...
    const jobs = [
        ...
        {
            title: "ארט דיירקטור (Art Director)",
            type: "משרה מלאה | משרדי החברה",
            labels: ["עיצוב", "קריאייטיב"],
            shortDesc: "התווית קו עיצובי למותגים, ניהול צוות מעצבים והובלת קמפיינים קריאטיביים מנצחים.",
            fullDesc: "אנחנו מחפשים ארט דיירקטור יצירתי/ת שנושם/ת עיצוב ודיגיטל. התפקיד כולל פיתוח שפות ויזואליות למותגים שונים, הנחיית מעצבים, בניית קונספטים שיווקיים והבאת רעיונות חדשניים לקמפיינים חוצי פלטפורמות. ניסיון קודם בסוכנות פרסום - חובה."
        },
        {
    ...
    return (
        <>
            <Reveal className="min-h-[85vh] bg-white pt-24 md:pt-32 pb-12 md:pb-16 text-right">
                <div className="max-w-[1000px] mx-auto px-6">
                    <h1 className="text-5xl md:text-7xl font-black uppercase mb-6 text-[#2f4ea1]">דרושים בספרוס</h1>

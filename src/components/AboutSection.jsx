        ...
        <div className="max-w-[1400px] mx-auto px-6 grid lg:grid-cols-2 gap-16 md:gap-24 items-center">
            <Reveal className="text-right">
                ...
                <p className="text-gray-600 text-lg md:text-xl font-light leading-relaxed mb-12">
                    הצוות שלנו מורכב מאנשי מקצוע מומחים – מנהלי מדיה ו-PPC, מומחי SEO וסושיאל, אסטרטגים, מעצבי UX ומפתחים שעובדים בסנכרון מלא. דיוק, חדשנות והתאמה אישית הם מה שאנחנו מביאים לשולחן המשותף.
                </p>
